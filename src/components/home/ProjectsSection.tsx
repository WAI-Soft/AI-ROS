      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <Card
              key={project.title}
              className="group overflow-hidden border-border hover:shadow-2xl transition-all duration-300 animate-fade-in-up hover:-translate-y-2"
            ...
            >
              <div className="relative h-56 overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  <span className="inline-block px-3 py-1 text-xs font-semibold text-white bg-secondary/90 rounded-full">
                    {project.category}
                  </span>
                </div>
              </div>
              ...
              <CardContent className="p-6">
                ...
                <Button
                  variant="ghost"
                  className="group/btn text-secondary hover:text-secondary p-0 h-auto font-semibold w-full justify-center"
                >
                  View Project
