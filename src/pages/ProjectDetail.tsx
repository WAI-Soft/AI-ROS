...
// Function to download case study as text file
...
Key Metrics:
${Object.entries(project.key_metrics).map(([key, value]) => `- ${key.replace(/_/g, ' ')}: ${value}`).join('\n')}
...
Generated by AI-ROS
  ...
  link.href = url;
  link.download = `${project.slug}-case-study.txt`;
